...
public final class UserRoleServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getGetRoleByIdMethod = UserRoleServiceGrpc.getGetRoleByIdMethod) == null) {
      synchronized (UserRoleServiceGrpc.class) {
        if ((getGetRoleByIdMethod = UserRoleServiceGrpc.getGetRoleByIdMethod) == null) {
          UserRoleServiceGrpc.getGetRoleByIdMethod =
              getGetRoleByIdMethod =
                  io.grpc.MethodDescriptor
                      .<net.coding.e.proto.UserRoleProto.GetUserRoleByIdRequest,
                          net.coding.e.proto.UserRoleProto.UserRoleResponse>
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              net.coding.e.proto.UserRoleProto.UserRoleResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new UserRoleServiceMethodDescriptorSupplier("getRoleById"))
                      .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<
    ...
    io.grpc.MethodDescriptor<
            ...
            net.coding.e.proto.UserRoleProto.UserGroupToSpinnakerResponse>
        getGetUserGroupToSpinnakerRoleMethod;
    if ((getGetUserGroupToSpinnakerRoleMethod =
            UserRoleServiceGrpc.getGetUserGroupToSpinnakerRoleMethod)
        == null) {
      synchronized (UserRoleServiceGrpc.class) {
        if ((getGetUserGroupToSpinnakerRoleMethod =
                UserRoleServiceGrpc.getGetUserGroupToSpinnakerRoleMethod)
          ...
          UserRoleServiceGrpc.getGetUserGroupToSpinnakerRoleMethod =
              getGetUserGroupToSpinnakerRoleMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      .setFullMethodName(
                          generateFullMethodName(SERVICE_NAME, "getUserGroupToSpinnakerRole"))
                      .setSampledToLocalTracing(true)
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              net.coding.e.proto.UserRoleProto.GetUserRoleByIdRequest
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              net.coding.e.proto.UserRoleProto.UserGroupToSpinnakerResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new UserRoleServiceMethodDescriptorSupplier(
                              "getUserGroupToSpinnakerRole"))
                      .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<
    ...
    io.grpc.MethodDescriptor<
            ...
            net.coding.e.proto.UserRoleProto.UserGroupToSpinnakerResponse>
        getGetUserGroupToSpinnakerRoleByGKMethod;
    if ((getGetUserGroupToSpinnakerRoleByGKMethod =
            UserRoleServiceGrpc.getGetUserGroupToSpinnakerRoleByGKMethod)
        == null) {
      synchronized (UserRoleServiceGrpc.class) {
        if ((getGetUserGroupToSpinnakerRoleByGKMethod =
                UserRoleServiceGrpc.getGetUserGroupToSpinnakerRoleByGKMethod)
          ...
          UserRoleServiceGrpc.getGetUserGroupToSpinnakerRoleByGKMethod =
              getGetUserGroupToSpinnakerRoleByGKMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      .setFullMethodName(
                          generateFullMethodName(SERVICE_NAME, "getUserGroupToSpinnakerRoleByGK"))
                      .setSampledToLocalTracing(true)
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              net.coding.e.proto.UserRoleProto.GetUserRoleByGKRequest
                      ...
                      .setSchemaDescriptor(
                          new UserRoleServiceMethodDescriptorSupplier(
                              "getUserGroupToSpinnakerRoleByGK"))
                      .build();
        }
      }
    }
   ...
   */
  public static UserRoleServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
    return new UserRoleServiceBlockingStub(channel);
  }

  /** Creates a new ListenableFuture-style stub that supports unary calls on the service */
  public static UserRoleServiceFutureStub newFutureStub(io.grpc.Channel channel) {
    return new UserRoleServiceFutureStub(channel);
  }

  /** */
  public abstract static class UserRoleServiceImplBase implements io.grpc.BindableService {

    /** */
    public void getRoleById(
        net.coding.e.proto.UserRoleProto.GetUserRoleByIdRequest request,
        io.grpc.stub.StreamObserver<net.coding.e.proto.UserRoleProto.UserRoleResponse>
            responseObserver) {
    ...
    public void getUserGroupToSpinnakerRole(
        net.coding.e.proto.UserRoleProto.GetUserRoleByIdRequest request,
        io.grpc.stub.StreamObserver<net.coding.e.proto.UserRoleProto.UserGroupToSpinnakerResponse>
            responseObserver) {
  ...
  /** */
  public static final class UserRoleServiceStub
      extends io.grpc.stub.AbstractStub<UserRoleServiceStub> {
    private UserRoleServiceStub(io.grpc.Channel channel) {
      super(channel);
    }

    private UserRoleServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected UserRoleServiceStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
    ...
    public void getRoleById(
        ...
        io.grpc.stub.StreamObserver<net.coding.e.proto.UserRoleProto.UserRoleResponse>
            responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getGetRoleByIdMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void getUserGroupToSpinnakerRole(
        ...
        io.grpc.stub.StreamObserver<net.coding.e.proto.UserRoleProto.UserGroupToSpinnakerResponse>
            responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getGetUserGroupToSpinnakerRoleMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void getUserGroupToSpinnakerRoleByGK(
        ...
        io.grpc.stub.StreamObserver<net.coding.e.proto.UserRoleProto.UserGroupToSpinnakerResponse>
            responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getGetUserGroupToSpinnakerRoleByGKMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
  ...
  /** */
  public static final class UserRoleServiceBlockingStub
      extends io.grpc.stub.AbstractStub<UserRoleServiceBlockingStub> {
    private UserRoleServiceBlockingStub(io.grpc.Channel channel) {
      super(channel);
    }

    private UserRoleServiceBlockingStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected UserRoleServiceBlockingStub build(
    ...
    public net.coding.e.proto.UserRoleProto.UserRoleResponse getRoleById(
        net.coding.e.proto.UserRoleProto.GetUserRoleByIdRequest request) {
      return blockingUnaryCall(getChannel(), getGetRoleByIdMethod(), getCallOptions(), request);
    }

    /** */
    public net.coding.e.proto.UserRoleProto.UserGroupToSpinnakerResponse
        getUserGroupToSpinnakerRole(
            net.coding.e.proto.UserRoleProto.GetUserRoleByIdRequest request) {
  ...
  /** */
  public static final class UserRoleServiceFutureStub
      extends io.grpc.stub.AbstractStub<UserRoleServiceFutureStub> {
    private UserRoleServiceFutureStub(io.grpc.Channel channel) {
      super(channel);
    }

    private UserRoleServiceFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected UserRoleServiceFutureStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            net.coding.e.proto.UserRoleProto.UserRoleResponse>
        getRoleById(net.coding.e.proto.UserRoleProto.GetUserRoleByIdRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ROLE_BY_ID:
          serviceImpl.getRoleById(
              (net.coding.e.proto.UserRoleProto.GetUserRoleByIdRequest) request,
              (io.grpc.stub.StreamObserver<net.coding.e.proto.UserRoleProto.UserRoleResponse>)
                  responseObserver);
          break;
        case METHODID_GET_USER_GROUP_TO_SPINNAKER_ROLE:
          serviceImpl.getUserGroupToSpinnakerRole(
              (net.coding.e.proto.UserRoleProto.GetUserRoleByIdRequest) request,
        ...
        case METHODID_GET_USER_GROUP_TO_SPINNAKER_ROLE_BY_GK:
          serviceImpl.getUserGroupToSpinnakerRoleByGK(
              (net.coding.e.proto.UserRoleProto.GetUserRoleByGKRequest) request,
              (io.grpc.stub.StreamObserver<
                      net.coding.e.proto.UserRoleProto.UserGroupToSpinnakerResponse>)
                  responseObserver);
  ...
  private abstract static class UserRoleServiceBaseDescriptorSupplier
